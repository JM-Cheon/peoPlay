...
<body>
	...
	<jsp:include page="../common/header.jsp"/>
		<main class="main">
            <div class="agreeToS_main">
                <div class="agreeToS_box">
                    <div class="agreeToS_title">
                        PeoPlay 서비스 이용약관 (필수)
                    </div>
                    <div class="agreeToS_body">
						1. 이용 약관<br><br>
			    
						제1장 총 칙<br><br>
			    
						제1조(목적)<br>
						이 약관은 "PeoPlay"(이하 "회사"라 한다)가 홈페이지에서 제공하는 모든 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.<br><br>
			    
						제2조(정의)<br>
						이 약관에서 사용하는 용어의 정의는 다음 각 호와 같습니다.<br>
						이용자 : 본 약관에 따라 회사가 제공하는 서비스를 받는 자<br>
						이용계약 : 서비스 이용과 관련하여 회사와 이용자간에 체결하는 계약<br>
						가입 : 회사가 제공하는 신청서 양식에 해당 정보를 기입하고, 본 약관에 동의하여 서비스 이용계약을 완료시키는 행위<br>
						...
						이용해지 : 회사 또는 회원이 서비스 이용이후 그 이용계약을 종료시키는 의사표시<br><br>
						...
						이용신청의 내용을 허위로 기재한 경우<br>
						사회의 안녕 질서 또는 미풍양속을 저해할 목적으로 신청하였을 때<br>
						기타 회사가 정한 이용신청 요건에 미비 되었을 때<br><br>
						...
						회원은 회사의 홈페이지에 공공질서 및 미풍양속에 위반되는 내용물이나 제3자의 저작권 등 기타권리를 침해하는 내용물을 등록하는 행위를 하지 않아야 합니다. 만약 이와 같은 내용물을 게재하였을 때 발생하는 결과에 대한 모든 책임은 회원에게 있습니다.<br><br>
						...
						회원이 회사의 홈페이지와 게시판에 음란물을 게재하거나 음란 사이트를 링크하는 경우<br>
						...
						시스템 점검이 필요한 경우 기타 불가항력적 사유가 있는 경우<br><br>
						...
						타인의 이용자ID 및 패스워드를 도용한 경우<br>
						서비스 운영을 고의로 방해한 경우<br>
						허위로 가입 신청을 한 경우<br>
						같은 사용자가 다른 ID로 이중 등록을 한 경우<br>
						공공질서 및 미풍양속에 저해되는 내용을 유포시킨 경우<br>
						타인의 명예를 손상시키거나 불이익을 주는 행위를 한 경우<br>
						서비스의 안정적 운영을 방해할 목적으로 다량의 정보를 전송하거나 광고성 정보를 전송하는 경우<br>
						정보통신설비의 오작동이나 정보 등의 파괴를 유발시키는 컴퓨터바이러스 프로그램 등을 유포하는 경우<br>
						회사 또는 다른 회원이나 제3자의 지적재산권을 침해하는 경우<br>
						타인의 개인정보, 이용자ID 및 패스워드를 부정하게 사용하는 경우<br>
						회원이 자신의 홈페이지나 게시판 등에 음란물을 게재하거나 음란 사이트를 링크하는 경우<br>
						기타 관련법령에 위반된다고 판단되는 경우<br><br>
                    	...
                    	(시행일) 이 약관은 2021년 5월 30일부터 시행합니다.
                    </div>
                    <div class="agreeToS_footer">
                        <button type="button" onclick="location.href='${ pageContext.servletContext.contextPath }/member/checkFavorite'">위 약관에 동의합니다.</button>
                        <button type="button" onclick="location.href='${ pageContext.servletContext.contextPath }'">메인으로</button>
                    </div>
                </div>
            </div>
        </main>
