		...
		<jsp:include page="../admin/common/adminMenu.jsp"/>
			...
			<div class="p-board-panel">
				...
				<section class="p-center-list">
					...
					<!--검색-->
					<form id="searchForm"  action="${ pageContext.servletContext.contextPath }/noticeAdmin/search"
...
const link = "${ pageContext.servletContext.contextPath }/noticeAdmin/ntclist";
const searchLink = "${ pageContext.servletContext.contextPath }/noticeAdmin/search";
