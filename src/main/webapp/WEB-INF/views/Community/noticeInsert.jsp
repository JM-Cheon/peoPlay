	...
	<div class="p-board-wrapper">
		<div class="p-board-container">
			...
			<div class="p-board-panel">
				...
				<form action="${ pageContext.servletContext.contextPath }/noticeAdmin/insertWrite" id="form" name="form" method="post">
				  <input type="hidden" name="userNo" value="${sessionScope.loginMember.userNo }"> 
					...
					<div class="p-board-detail">
						<dl>
							<dt>제목</dt>
							<dd>
								<input type="text" class="p-input-box" name="ntcTitle" id="ntcTitle" placeholder="사진 사이즈를 작게 조정해 주세요!">
							</dd>
						</dl>
							<textarea id="summernote" name="ntcContent"></textarea>
						</div>
					</form>
					<!--//상세-->
