...
public class MovieDTO {
	...
	private MovieFileDTO movieFile;
...
//	private List<ActorDTO> actorList;
	...
	public MovieDTO(int no, String name, String info, String director, int productionYear, String movieTime, int like,
			int dislike, String watchFear, String watchModification, String watchDrug, String watchSensationality,
			String watchScript, String watchTitle, String watchViolence, String ratingName, String movieStatus,
			Date registrationDate, Date movieEndDate, String genreName, String movieVideoRink, MovieFileDTO movieFile) {
		this.no = no;
		this.name = name;
		this.info = info;
	...
	public MovieFileDTO getMovieFile() {
		return movieFile;
	}


	public void setMovieFile(MovieFileDTO movieFile) {
		this.movieFile = movieFile;
	}
