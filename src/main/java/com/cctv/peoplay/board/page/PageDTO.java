package com.cctv.peoplay.board.page;
...
public class PageDTO {
	...
	private int startRow;			// DB 조회 시 최신 글 부터 조회해야 하는 행의 시작 row 수
	private int endRow;				// DB 조회 시 최신 글 부터 조회해야 하는 행의 마지막 row 수
	
	public PageDTO() {}
	public PageDTO(int pageNo, int totalCount, int limit, int buttonAmount, int maxPage, int startPage, int endPage,
