...
public static PageDTO getPageInfo(int pageNo, int totalCount,int limit, int buttonAmount) {
...
//		DB에서 조회 할 시작 번호와 마지막 행 번호를 계산
		...
		PageDTO pageInfo = new PageDTO(pageNo, totalCount,limit,buttonAmount,maxPage,startPage,endPage,startRow,endRow);
