package com.cctv.peoplay.admin.goods.paging;
...
public class PagenationDTO {
	...
	public String toString() {
		return "PagenationDTO [pageNo=" + pageNo + ", totalcount=" + totalcount + ", limit=" + limit + ", buttonAmount="
				+ buttonAmount + ", maxPage=" + maxPage + ", startPage=" + startPage + ", endPage=" + endPage
				+ ", startRow=" + startRow + ", endRow=" + endRow + "]";
	}
	public PagenationDTO() {
	}
	public PagenationDTO(int pageNo, int totalcount, int limit, int buttonAmount, int maxPage, int startPage,
	...
	private int startRow;		// DB 조회 시 최신 글부터 조회히야 하는 행의 시작 row  수
