...
public class Pagenation {
	public static PagenationDTO getPageInfo(int pageNo, int totalCount, int limit, int buttonAmount) {
...
//		System.out.println("endRow : " + endRow);
		...
		PagenationDTO pageInfo = new PagenationDTO(pageNo, totalCount, limit, buttonAmount, 
